...
public class Freebase {
	...
	private String apiKey="key=AIzaSyCizQnhxMCiLH-mAoQdFKb7rvGAVbof_98";
	...
	private String placeUrlTail="?props=&lang=en&filter=%2Ftravel%2Ftravel_destination%2Ftourist_attractions&limit=50&";
	...
	public HashMap<String,String> freebasePlaceTopic(String cityId) throws IOException
    {
        ...
        searchUrl=new URL(topicUrl);
        urlConnection=searchUrl.openConnection();
